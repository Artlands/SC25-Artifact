#!/bin/bash
#SBATCH --job-name=ct_4_sst                          # Job name
#SBATCH --nodes=1                                    # Number of nodes
#SBATCH --ntasks-per-node=4                          # Number of tasks per node
#SBATCH --time=01:00:00                              # Time limit (hh:mm:ss)
#SBATCH --output=../results/ct_4_%A_%a.out           # Standard output log
...
srun -n 1 sst -n 4 ../rev-xbgas-ct-topo.py --model-options="-c ../$conf/sim4.cfg"
