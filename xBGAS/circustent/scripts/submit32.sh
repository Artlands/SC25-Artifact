#!/bin/bash
#SBATCH --job-name=ct_32_sst                         # Job name
#SBATCH --nodes=1                                    # Number of nodes
#SBATCH --ntasks-per-node=32                         # Number of tasks per node
#SBATCH --time=04:00:00                              # Time limit (hh:mm:ss)
#SBATCH --output=../results/ct_32_%A_%a.out          # Standard output log
...
srun -n 1 sst -n 32 ../rev-xbgas-ct-topo.py --model-options="-c ../$conf/sim32.cfg"
